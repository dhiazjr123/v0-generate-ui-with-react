...
export default function RegisterPage() {
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: { username },
          // jika email confirmation aktif, user akan diarahkan kembali ke app
          emailRedirectTo: `${location.origin}/auth/callback`,
        },
      });
      if (error) throw error;

      setOk("Akun berhasil dibuat. Jika verifikasi email aktif, silakan cek email Anda.");
  ...
  return (
    <main className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      {/* KIRI – placeholder gambar (selaras login & figma) */}
          ...
          <form onSubmit={onSubmit} className="space-y-4" autoComplete="off">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                autoComplete="username"         // atau "new-username" jika Chrome masih autofill email
                autoCapitalize="none"
                spellCheck={false}
